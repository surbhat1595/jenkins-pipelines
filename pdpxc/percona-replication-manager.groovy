library changelog: false, identifier: 'lib@PXC-4062', retriever: modernSCM([
    $class: 'GitSCMSource',
...
pipeline {
    ...
    parameters {
        string(
            defaultValue: 'https://github.com/surbhat1595/replication-manager.git',
            description: 'URL for  percona-replication-manager repository',
            name: 'GIT_REPO')
        string(
            defaultValue: 'PXC-4062',
