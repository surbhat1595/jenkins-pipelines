    ...
    stages {
        stage('Run Percona Telemetry Script') {
            parallel {
                ...
                stage('Test on Ubuntu Resolute (x64)') {
                    agent { label 'min-resolute-x64' }  // Run on the node with label 'min-resolute-x64'
                    steps {
                        script {
                            sh '''
                            # Update package list and install necessary dependencies
                ...
                stage('Test on Ubuntu Resolute (aarch64)') {
                    agent { label 'min-resolute-aarch64' }  // Run on the node with label 'min-resolute-aarch64'
                    steps {
                        script {
                            sh '''
                            # Update package list and install necessary dependencies
