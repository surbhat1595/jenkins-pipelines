      ...
      sh """
          ...
          if [ \${FIPSMODE} = "YES" ]; then
              ...
              curl -L -H "Authorization: Bearer \${TOKEN}" \
                      ...
                      -o pxc_builder.sh \
                      "https://api.github.com/repos/surbhat1595/percona-xtradb-cluster-private-build/contents/build-ps/pxc_builder.sh?ref=\${PRO_BRANCH}"
          else
          ...
          docker run -u root -v \${build_dir}:\${build_dir} ${DOCKER_OS} sh -c "
              ...
              if [ \${FIPSMODE} = "YES" ]; then
                  git clone --depth 1 --branch \${PRO_BRANCH} https://x-access-token:\${TOKEN}@github.com/surbhat1595/percona-xtradb-cluster-private-build.git percona-xtradb-cluster-private-build
